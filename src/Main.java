...
// Getting users name in a nice way
    System.out.print("Mein Name lautet: "); usr = scanner.nextLine();
...
// Age Guessing Game
    ...
    System.out.print(usr + ": Mein Ergebnis ist: "); int modulo3 = scanner.nextInt();
    System.out.println('\n' + cpu + "Gut so! Der nächste Modulo lautet '5'");
    System.out.print(usr + ": Mein Ergebnis ist: "); int modulo5 = scanner.nextInt();
    System.out.println('\n' + cpu + "Sehr gut! Gleich geschafft!");
    System.out.println(cpu + "Der letzte Modulo lautet '7'");
    System.out.print(usr + ": Mein Ergebnis ist: "); int modulo7 = scanner.nextInt();
...
// Binary arithmetic operators
    ...
    System.out.print(usr + ": "); long addition = scanner.nextLong();
    System.out.println('\n' + cpu + "Deine Lieblingszahl lautet: " + addition);
    System.out.println(cpu + "Mit welcher Zahl möchtest du sie addieren?");
    System.out.print(usr + ": "); long addition2 = scanner.nextLong();
    // Prevents the upcoming nextLine() from unwanted execution.
    scanner.nextLine();
